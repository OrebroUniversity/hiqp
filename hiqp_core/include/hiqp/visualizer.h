...
/*! \brief An interface for visualizing geometric primitives. Derive from this
 * class to implement your own visualizer and provide it to TaskManager to get
 * visualization of HiQP.
