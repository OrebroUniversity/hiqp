...
/*! \brief Parameters: [n.x, n.y, n.z, offset]. The plane equation corresponds
 * to \f$n^T*x-offset=0\f$.
 *  \author Marcus A Johansson */
class GeometricPlane : public GeometricPrimitive {
 public:
  GeometricPlane(const std::string& name, const std::string& frame_id,
   ...
   *                      <li>Indices 0-2 (required) defines the normal vector
   * of the plane.</li>
   *                      <li>Index 3 (required) defines the offset of the plane
