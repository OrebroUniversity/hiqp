...
namespace hiqp {
  namespace tasks {
    ...
    int TDynLinearImpedance::init(const std::vector<std::string>& parameters, RobotStatePtr robot_state, const Eigen::VectorXd& e_initial, const Eigen::VectorXd& e_dot_initial, const Eigen::VectorXd& e_final, const Eigen::VectorXd& e_dot_final) {
   ...
   //  }  
    ...
    int TDynLinearImpedance::update(const RobotStatePtr robot_state, const std::shared_ptr< TaskDefinition > def){
