...
std::ostream& operator<<(std::ostream& os, const HiQPStage& stage) {
  ...
  for (int i : stage.constraint_signs_) os << i << ", ";
...
bool CasADiSolver::solve(std::vector<double>& solution) {
  ...
  casadi::SX g_i;
  std::vector<double> lbx(solutionSize,
                          -std::numeric_limits<double>::infinity());
  std::vector<double> ubx(solutionSize,
                          std::numeric_limits<double>::infinity());
